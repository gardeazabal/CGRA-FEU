...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.p = new MyParallelogram(this);
        
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.cube, this.p];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Tangram': 3, 'Cube': 4, 'P': 5};
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0, 0, 0.0, 1.0);
        this.material4.setDiffuse(0.9, 0.45, 0, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.ambientComponent, this.ambientComponent,this.ambientComponent, 1.0);
